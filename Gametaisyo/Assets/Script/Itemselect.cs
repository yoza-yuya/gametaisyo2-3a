...
public class Itemselect : MonoBehaviour
{
     ...
     */
    private Image[] WeponImage = new Image[7];
    /*
    ...
    public void SetLevelOne()
    {
        for (int i = 0; i < Wepon.Length; i++)
        {
            ...
            WeponImage[i].sprite = SyokkakuSprite;
    ...
    public void SetLevelTwo()
    {
        ...
        for (int i = 0; i < Wepon.Length; i++)
        {
            ...
            if (i % 2 == 0)
            {
                WeponImage[i].sprite = MikakuSprite;
            }
            else
            {
                WeponImage[i].sprite = SyokkakuSprite;
        ...
        for (int i = 0; i < Wepon.Length; i++)
        {
            ...
            switch (i)
            {
                case 1:
                    ...
                    break;
                case 2:
                    WeponImage[i].sprite = SikakuSprite;
                    break;
                case 3:
                    WeponImage[i].sprite = MikakuSprite;
                    break;
                case 4:
                    WeponImage[i].sprite = KyuukakuSprite;
                    break;
                case 5:
                    WeponImage[i].sprite = TyoukakuSprite;
                    break;
                case 6:
                    WeponImage[0].sprite = WeponImage[5].sprite;
             ...
             * 両端の武器画像を透明、真ん中3つの画像はそのまま
             */
            if (i == 0 || i == 6) WeponImage[i].color = new Color(255, 255, 255, 0);
            else WeponImage[i].color = new Color(255, 255, 255, 255);
        }
    }
        ...
        if (SlideFlag)
        {
            ...
            for (int i = 0; i < Wepon.Length; i++)
            {
                ...
                if (WeponRect[i].localPosition.x == Main.x)
                {
                     ...
                     */
                    if (WeponImage[i].sprite == SyokkakuSprite)
                    {
                        WeponType = 0;
                    }
                    else if (WeponImage[i].sprite == MikakuSprite)
                    {
                        WeponType = 1;
                    }
                    else
    ...
    void Update()
    {
         ...
         *      Hキー : UIを右にスライド
         */
        if (Input.GetKeyDown("joystick button 4") && !SlideFlag)
        {
            SlideFlag = true;
            PosFlag = true;
            Dir = 0;
        }
        if (Input.GetKeyDown("joystick button 5") && !SlideFlag)
        {
            SlideFlag = true;
            PosFlag = true;
            Dir = 1;
